"""
Formating the True clusters from the simulated correspondance file 
"""
...
def main():
    usage = "python  format_simulated_data.py -i <simulated coresspondant file> -o <True cluster formatted file name>\n "
