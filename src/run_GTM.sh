...
mv ${name}_final_clusters_seq_info.txt Output/${name}
mv ${name}_unannotated_seq.txt Output/${name}
mv ${name}_initial_clusters_Fo.txt Output/${name}
mv ${name}_final_clusters_Fo.txt Output/${name}
mv ${name}_cluster_distribution.txt Output/${name}
mv ${name}_repertoire.png Output/${name}
